...
export ZIMAGI_CLI_POSTGRES_PORT=${ZIMAGI_CLI_POSTGRES_PORT:-$DEFAULT_CLI_POSTGRES_PORT}
export ZIMAGI_CLI_REDIS_PORT=${ZIMAGI_CLI_REDIS_PORT:-$DEFAULT_CLI_REDIS_PORT}
export ZIMAGI_CLI_COMMAND_PORT=${ZIMAGI_CLI_COMMAND_PORT:-$DEFAULT_CLI_COMMAND_PORT}
export ZIMAGI_CLI_DATA_PORT=${ZIMAGI_CLI_DATA_PORT:-$DEFAULT_CLI_DATA_PORT}
export ZIMAGI_CLI_FORM_PORT=${ZIMAGI_CLI_FORM_PORT:-$DEFAULT_CLI_FORM_PORT}
export ZIMAGI_CLI_CELERY_FLOWER_PORT=${ZIMAGI_CLI_CELERY_FLOWER_PORT:-$DEFAULT_CLI_CELERY_FLOWER_PORT}

export ZIMAGI_KUBERNETES_COMMAND_PORT=${ZIMAGI_KUBERNETES_COMMAND_PORT:-$DEFAULT_KUBERNETES_COMMAND_PORT}
export ZIMAGI_KUBERNETES_DATA_PORT=${ZIMAGI_KUBERNETES_DATA_PORT:-$DEFAULT_KUBERNETES_DATA_PORT}
...
EOF
    ignore_vars=(
        ...
        "ZIMAGI_CLI_DATA_PORT"
        "ZIMAGI_CLI_FORM_PORT"
        "ZIMAGI_CLI_CELERY_FLOWER_PORT"
        "ZIMAGI_KUBERNETES_COMMAND_PORT"
        "ZIMAGI_KUBERNETES_DATA_PORT"
        "ZIMAGI_AUTO_UPDATE"
        "ZIMAGI_SECRET_KEY"
        "ZIMAGI_POSTGRES_DB"
