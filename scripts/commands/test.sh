...
function test_command () {
  ...
  export ZIMAGI_SERVER_WORKERS=${ZIMAGI_SERVER_WORKERS:-1}
  export ZIMAGI_WORKER_MAX_PROCESSES=${ZIMAGI_WORKER_MAX_PROCESSES:-1}
  export ZIMAGI_WORKER_TIMEOUT=${ZIMAGI_WORKER_TIMEOUT:-0}
