    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('environment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='project_relation', to='environment.Environment')),
                ('groups', models.ManyToManyField(related_name='project_relation', to='group.Group')),
            ],
            options={
                'abstract': False,
            },
