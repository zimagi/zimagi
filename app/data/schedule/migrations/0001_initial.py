        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "enabled",
                    models.BooleanField(
                        default=True, help_text="Set to False to disable the schedule", verbose_name="Enabled"
                    ),
                ),
                (
                    "last_run_at",
                ...
                (
                    "user",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.PROTECT, related_name="schedules", to="user.user"
                    ),
                ),
            ],
            options={
