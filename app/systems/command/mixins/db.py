...
class DatabaseMixin(DataMixin):
    ...
    def parse_db_dir(self, optional = '--dir', help_text = 'database directory within module'):
    ...
    def parse_file_name(self, optional = False, help_text = 'database file name within module'):
    ...
    @property
    def db_file_path(self, module):
        file_location = os.path.join(self.db_dir, self.file_name)
        return module.module_path(file_location)
