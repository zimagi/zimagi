...
function hook_update_host () {
  info "Checking Zimagi CLI ${__environment} connection ..."
  run_subcommand zimagi user list --host="${__environment}"
  run_subcommand zimagi config save option_environment_host "${__environment}"
}